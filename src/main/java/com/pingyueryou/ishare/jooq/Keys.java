...
public class Keys {
    ...
    public static final Identity<IShareCommentRecord, Long> IDENTITY_I_SHARE_COMMENT = Identities0.IDENTITY_I_SHARE_COMMENT;
    public static final Identity<IShareLikeRecord, Long> IDENTITY_I_SHARE_LIKE = Identities0.IDENTITY_I_SHARE_LIKE;
    ...
    public static final UniqueKey<IShareCommentRecord> KEY_I_SHARE_COMMENT_PRIMARY = UniqueKeys0.KEY_I_SHARE_COMMENT_PRIMARY;
    public static final UniqueKey<IShareLikeRecord> KEY_I_SHARE_LIKE_PRIMARY = UniqueKeys0.KEY_I_SHARE_LIKE_PRIMARY;
    public static final UniqueKey<IShareLikeRecord> KEY_I_SHARE_LIKE_UK_SHARE_USER_ID = UniqueKeys0.KEY_I_SHARE_LIKE_UK_SHARE_USER_ID;
    ...
    private static class Identities0 {
        ...
        public static Identity<IShareCommentRecord, Long> IDENTITY_I_SHARE_COMMENT = Internal.createIdentity(IShareComment.I_SHARE_COMMENT, IShareComment.I_SHARE_COMMENT.ID);
        public static Identity<IShareLikeRecord, Long> IDENTITY_I_SHARE_LIKE = Internal.createIdentity(IShareLike.I_SHARE_LIKE, IShareLike.I_SHARE_LIKE.ID);
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<IShareCommentRecord> KEY_I_SHARE_COMMENT_PRIMARY = Internal.createUniqueKey(IShareComment.I_SHARE_COMMENT, "KEY_i_share_comment_PRIMARY", IShareComment.I_SHARE_COMMENT.ID);
        public static final UniqueKey<IShareLikeRecord> KEY_I_SHARE_LIKE_PRIMARY = Internal.createUniqueKey(IShareLike.I_SHARE_LIKE, "KEY_i_share_like_PRIMARY", IShareLike.I_SHARE_LIKE.ID);
        public static final UniqueKey<IShareLikeRecord> KEY_I_SHARE_LIKE_UK_SHARE_USER_ID = Internal.createUniqueKey(IShareLike.I_SHARE_LIKE, "KEY_i_share_like_uk_share_user_id", IShareLike.I_SHARE_LIKE.USER_ID, IShareLike.I_SHARE_LIKE.SHARE_ID);
